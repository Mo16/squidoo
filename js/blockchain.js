...
addresses = ["0x3454e652bd19eba7447ede7bd089ea48ecbff33a", "0x8ef46bb46df387845c2302dcf85c85b0a7d3dac6"]
...
const ABI = [{
        "inputs": [{
            ...
            },
            {
                ...
                "name": "_firstPartyWallet",
                "type": "address"
            },
            {
                "internalType": "address",
                "name": "_secondPartyWallet",
                "type": "address"
            },
            {
                "internalType": "address",
            ...
            },
            {
                ...
                "name": "_firstPartySplit",
                "type": "uint256"
            },
            {
                "internalType": "uint256",
                "name": "_secondPartySplit",
                "type": "uint256"
            },
            {
                "internalType": "uint256",
                "name": "_thirdPartySplit",
                "type": "uint256"
            },
            {
                "internalType": "address",
...
let contractAddress = "0x0f2b62b189dB519748911cB086C3A8b349aAaA59";
...
async function mintAllowlist() {
    if (mintstatus) {
        ...
        try {
            ...
            let name = await contract.allowlistMint(1, proof, overrides)
            name.wait()
